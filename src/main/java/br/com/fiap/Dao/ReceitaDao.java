...
import br.com.fiap.exception.ReceitaDaoException;
...
public class ReceitaDao {
    ...
    public void insert(Receita receita) throws SQLException, ReceitaDaoException {
        try {
            ...
            throw new ReceitaDaoException("Erro ao cadastrar a receita",e);
        }
    }


    public List<Receita> getAll() throws SQLException, ReceitaDaoException {
       try {
           ...
           throw new ReceitaDaoException("Erro ao buscar a receita",e);
       }
    }
}
